...
var passport = require('passport-strategy')
  ...
  , fidou2f = require('./fido2/attestation/fido-u2f')
  , packed = require('./fido2/attestation/packed')
  , safetynet = require('./fido2/attestation/android-safetynet')
  , utils = require('./utils')
  , url = require('url')
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (clientData.type === 'webauthn.get') {
    ...
    case 'fido-u2f':
      //pa = fidou2f.parse(attestation.attStmt);
      vatt = fidou2f.verify(attestation.attStmt, attestation.authData, hash);
      break;
    case 'packed':
      //pa = packed.parse(attestation.attStmt);
      vatt = packed.verify(attestation.attStmt, attestation.authData, hash);
      break;
    case 'android-safetynet':
      vatt = safetynet.verify(attestation.attStmt, attestation.authData, hash);
      break;
    }
    ...
    try {
      if (self._passReqToCallback) {
        ...
        switch (arity) {
        case 7:
          return this._register(id, pem, flags, authenticatorData.signCount, response.transports, vatt, registered);
        case 6:
