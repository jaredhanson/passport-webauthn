    ...
    if (clientData.type === 'webauthn.get') {
      ...
      try {
        if (self._passReqToCallback) {
          ...
          default:
            return self._verify(req, id, verified);
          }
        } else {
          var arity = self._verify.length;
          switch (arity) {
          ...
          default: // TODO: Get rid of this and require userHandle
            return self._verify(id, verified);
          }
        }
      } catch (ex) {
      ...
      try {
        if (self._passReqToCallback) {
          ...
          switch (arity) {
          case 7:
            return self._register(id, pem, flags, authenticatorData.signCount, response.transports, vAttestation, registered);
          case 6:
            return self._register(id, pem, flags, authenticatorData.signCount, response.transports, registered);
          case 5:
            return self._register(id, pem, flags, authenticatorData.signCount, registered);
          case 4:
            return self._register(id, pem, flags, registered);
          default:
            return self._register(id, pem, registered);
          }
        }
      } catch (ex) {
        return self.error(ex);
