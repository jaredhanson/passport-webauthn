    ...
    if (clientData.type === 'webauthn.get') {
      ...
      try {
        if (self._passReqToCallback) {
          ...
          switch (arity) {
          case 7:
            return self._register(credentialId, pem, flags, authenticatorData.signCount, response.transports, vAttestation, registered);
          case 6:
            return self._register(credentialId, pem, flags, authenticatorData.signCount, response.transports, registered);
          case 5:
            return self._register(credentialId, pem, flags, authenticatorData.signCount, registered);
          case 4:
            return self._register(credentialId, pem, flags, registered);
          default:
            return self._register(credentialId, pem, registered);
          }
        }
      } catch (ex) {
        return self.error(ex);
